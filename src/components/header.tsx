...
const Header = () => {
  ...
  console.log(page);
  return (
    <div className="p-4 flex items-center justify-between bg-darkBlue">
      ...
      <div className="w-[24px] h-[24px] border-[1px] flex justify-center items-center border-white rounded-[50%]">
        <img className="w-6 h-6" src="/assets/image-avatar.png" />
      </div>
    </div>
  );
};
